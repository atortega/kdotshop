            ...
            <div class="row">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="navbar-brand clearfix hidden-lg-up">
                      ...
                      <div id="logo-mobile" class="logo">
                        <a href="/"><img id="logo-img-mobile" src="image/kdot_newlogo.png" alt="kdot_newlogo"></a>
                      </div>
                    ...
                    <div class="header-dropdown-buttons hidden-lg-up p-0 ml-auto mr-3">
                      ...
                      <div class="btn-group">
                        <button type="button" class="btn dropdown-toggle dropdown-toggle--no-caret" id="header-drop-4"  aria-haspopup="true" aria-expanded="false"><i class="fa fa-shopping-basket" href="/shop-cart"></i><span class="cart-count default-bg">8</span></button>
                      </div>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                      ...
                      <ul class="navbar-nav ml-xl-auto">
                        ...
                        <li class="nav-item dropdown  mega-menu mega-menu--narrow">
                          <a href="/about_page" class="nav-link " >About Us</a>
              ...
              <div class="col-auto hidden-md-down">
                ...
                <div class="header-dropdown-buttons">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn dropdown-toggle dropdown-toggle--no-caret" id="header-drop-2"  aria-haspopup="true" aria-expanded="false"><i class="fa fa-shopping-basket" href="/shop-cart"></i><span class="cart-count default-bg">8</span></button>
