...
<html dir="ltr" lang="zxx">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ URL::asset('css/user/bootstrap/css/bootstrap.css')}}" rel="stylesheet">
              ...
              <div class="col-md-auto hidden-md-down">
                ...
                <div class="header-first clearfix">
                  ...
                  <div id="logo" class="logo">
                    <a href="index.html"><img id="logo_img" src=""{{ URL::asset('images/logo_light_blue.png')}}" alt="The Project"></a>
                  </div>
                            ...
                            <li>
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-3 hidden-md-down">
                                  ...
                                  <img src=""{{ URL::asset('images/section-image-3.png')}}" alt="The Project">
                                </div>
                              </div>
                            </li>
                          </ul>
