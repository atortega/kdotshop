  ...
  <body class="front-page transparent-header">
    ...
    <div class="page-wrapper">
      ...
      <div class="header-container">
        ...
        @include('user.html.templates.header')
      ...
      <!-- banner start -->
      <!-- ================ -->
      @include('user.html.templates.banner')
      <!-- banner end -->
      ...
      <section class="light-gray-bg pv-30 clearfix">
         @include('user.html.templates.section_latest_products')
      </section>
    <!-- section end -->
          ...
          <section class="section light-gray-bg clearfix">
            @include('user.html.templates.section_featured_categories')
          </section>
          <!-- section end -->
        </div>
      </section>
      ...
      <!-- ================ -->
      <section class="pv-30">
        @include('user.html.templates.section_top_sellers')
      ...
      <!-- ================ -->
      @include('user.html.templates.footer')
