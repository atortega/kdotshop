    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Products SKU</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="container-fluid col-lg-12">
                    <a href="/admin/sku/create" class="btn btn-primary btn-xs" role="button">Add New</a>
                    <div class="mb-3">&nbsp;</div>
                ...
                <script>
                    $(function(){
                        ...
                        $('#table').on('click', '.sku-delete-btn', function(){
                            var sku_id = $(this).attr('sid');
                            var product_name = $(this).attr('sname');
                            bootbox.confirm({
                                size: "small",
                                message: "Do you want to delete this product sku, <strong>"+product_name+"</strong>?",
