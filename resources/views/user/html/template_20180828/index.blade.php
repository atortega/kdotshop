              ...
              <div class="col-md-auto hidden-md-down">
                ...
                <div class="header-first clearfix">
                  ...
                  <div id="logo" class="logo">
                    <a href="index.html"><img id="logo_img" src="image/kdot_newlogo.png" alt="kdot_newlogo"></a>
                  </div>
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="navbar-brand clearfix hidden-lg-up">
                      ...
                      <div id="logo-mobile" class="logo">
                        <a href="index.html"><img id="logo-img-mobile" src="image/kdot_newlogo.png" alt="kdot_newlogo"></a>
                      </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                      ...
                      <ul class="navbar-nav ml-xl-auto">
                        ...
                        <li class="nav-item dropdown  mega-menu mega-menu--wide">
                          <a href="#" class="nav-link dropdown-toggle" id="second-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Products</a>
                        ...
                        <li class="nav-item dropdown  mega-menu mega-menu--narrow">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="fourth-dropdown">
                            <li>
                              <div class="row">
                                <div class="col-md-12">
                                  <h4 class="title"><i class="fa fa-magic pr-2"></i> About Us</h4>
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <div class="divider"></div>
                                      <ul class="menu">
            ...
            <div id="slider-banner-fullscreen" class="slider-banner-fullscreen rev_slider" data-version="5.0">
              <ul class="slides">
                ...
                <li class="text-center" data-transition="random" data-slotamount="default" data-masterspeed="default" data-title="Slide Title">
                  ...
                  <!-- main image -->
                  <img src="image/kdot_logo.jpg" alt="slidebg1" data-bgposition="center center" data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                ...
                <li data-transition="random" data-slotamount="7" data-masterspeed="default" data-title="Premium HTML5 Bootstrap Theme">
                  ...
                  <!-- main image -->
                  <img src="image/logo2.jpg" alt="slidebg2" data-bgposition="center center" data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
    ...
    <!-- section end -->
      ...
      <section class="pv-30">
        <div class="container">
          <div class="row justify-content-md-center">
            <div class="col-lg-8">
              <h2 class="text-center mt-4"> <strong>Product</strong> Categories</h2>
              <div class="separator"></div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              ...
              <ul class="list-icons">
                <li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100"><i class="fa fa-check-square-o"></i> 27 Predifined Home Pages</li>
                <li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="150"><i class="fa fa-check-square-o"></i> Ipsum quas repellendus of incidunt</li>
                <li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="200"><i class="fa fa-check-square-o"></i> Unt loremcu</li>
                <li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="250"><i class="fa fa-check-square-o"></i> 190+ HTML files</li>
              </ul>
                  ...
                  <div class="footer-content">
                    ...
                    <nav>
                      <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Terms and Condition</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"></a></li>
                        <li class="nav-item"><a class="nav-link" href="page-about.html"></a></li>
                      </ul>
                    </nav>
                  </div>
                </div>
