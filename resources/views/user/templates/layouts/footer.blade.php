				...
				<div class="row">	
					...
					<div class="col-lg-3">
						<div class="footer-content">
							...
							<ul class="list-icons">
								<li>
									<i class="fa fa-map-marker pr-2 text-default"></i>
									Santorini, Talamban, Cebu City
								</li>
								<li>
									<i class="fa fa-phone pr-2 text-default"></i>
									+63 9336892054
								</li>
								<li>
									<a href="mailto:kdotshop2k18@gmail.com">
										<i class="fa fa-envelope-o pr-2"></i>
										kdotshop2k18@gmail.com
									</a>
								</li>
							</ul>
						</div>
		...
		<div class="container">
			<div class="subfooter-inner">
				<div class="row">
					<div class="col-md-12">
						<p class="text-center">
							Copyright © 2018 KDot Shop. All rights reserved.
						</p>
					</div>
				</div>
			</div>
