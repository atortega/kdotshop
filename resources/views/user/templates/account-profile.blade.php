                    ...
                    <div class="col-auto">
                      ...
                      <div class="main object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100">
                        <div class="form-block p-30 light-gray-bg border-clear">
                            <a href="http://local.kdotshop.com/account-updatePROF" class="d-inline-block float-right"
                              style="color: #f49ac1; font-weight: bold; text-decoration:none;">Edit
                            </a> 
                          ...
                          <form class="form-horizontal">
                                ...
                                <div class="form-group has-feedback row" >
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="inputConfirmPassword" placeholder=" Password" required>
                                        <a href="http://local.kdotshop.com/account-updatePSW" class="d-inline-block float-right"
                                          style="color: #f49ac1; font-weight: bold; text-decoration:none;">Change Password
                                         </a>                                     
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-feedback row" >
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="inputVerficationCode" placeholder="Number" required>                             
                                    </div>
                                </div>
                                <br>
